...
const services = [
  ...
  },
  {
    ...
    description: "Custom animations that bring your website to life",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-20 bg-purple-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            We offer a range of services to help you create stunning web experiences
          </motion.p>
        </div>
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="text-purple-600 dark:text-purple-400 mb-4 flex justify-center">{service.icon}</div>
