          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 bg-purple-600 text-white">
                ...
                <p className="mb-8">Fill out the form and we'll get back to you as soon as possible.</p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p>123 Animation Street, Web City, 10001</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    ...
                    >
                      ...
                      <input
                        type="text"
                        id="first-name"
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-purple-500 focus:border-purple-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      />
                    </motion.div>
