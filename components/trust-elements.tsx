  ...
  const trustItems = [
    {
      ...
      description: "Certified Apple Developer Program Member",
    },
    {
      icon: (
        <svg
      ...
      title: "50+ iOS Apps",
      description: "Successfully published on the App Store",
    },
    {
      icon: (
        <svg
      ...
      description: "Across all our App Store submissions",
    },
  ]
